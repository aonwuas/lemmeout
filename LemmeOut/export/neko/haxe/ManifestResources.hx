...
@:keep @:bind #if display private #end class __ASSET__assets_images_tilesmaptest_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_data_gd1_tiledset1_tsx extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_data_maptest1_tmx extends null { }
