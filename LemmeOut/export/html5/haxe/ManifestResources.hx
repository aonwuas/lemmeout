...
@:keep @:image("assets/images/GD1_blobMasterSheet.png") #if display private #end class __ASSET__assets_images_gd1_blobmastersheet_png extends lime.graphics.Image {}
